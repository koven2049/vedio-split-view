...
const video: MdVideo = {
  ...
  segments: [
    {
      segment_index: 0, title: '第一段', title_en: 'Part one',
      summary: '第一段摘要', summary_en: 'First summary',
      start_seconds: 0, end_seconds: 60,
    },
    {
      segment_index: 1, title: '第二段', title_en: 'Part two',
      summary: '第二段摘要', summary_en: '',
      start_seconds: 60, end_seconds: 130,
    },
  ],
}
